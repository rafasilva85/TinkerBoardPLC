var MASvrHelper = (function () {
    ...
    MASvrHelper.prototype.init = function (apiOpts, onApiLoaded) {
        ...
        this.apiOpts.user = apiOpts != null && apiOpts.user != null && apiOpts.user != "" ? apiOpts.user : "Guest";
    ...
    MASvrHelper.prototype._getServicesUrl = function () {
        ...
        if (host != null && host.win != null) {
            ...
            if (win.SmaCustomWidget != null && win.SmaCustomWidget.MASvrHelper != null && win.SmaCustomWidget.MASvrHelper._getServicesUrl != null) {
    ...
    MASvrHelper.prototype._getLinkUrlFromContainerApi = function () {
        ...
        if (host != null && host.win != null) {
            ...
            if (win.SmaCustomWidget != null && win.SmaCustomWidget.MASvrHelper != null && win.SmaCustomWidget.MASvrHelper._getLinkUrlFromContainerApi != null) {
                // container is custom widget, and contains MA server helper
